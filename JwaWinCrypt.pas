...
// Fr0sT-Brutal: simplified to always use Winapi.Windows unit, removed external
// dependencies except JwaBaseTypes, removed dynamic loading, removed include mode.

// $Id: JwaWinCrypt.pas,v 1.17 2007/09/05 11:58:53 dezipaitor Exp $

// Presume we're on Vista+ so set these defines that couldn't be used in any OS
{$UNDEF WINXP}
{$DEFINE WINXP_UP}
{$DEFINE WIN2003_UP}
