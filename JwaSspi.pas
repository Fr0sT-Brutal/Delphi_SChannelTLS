...
// Fr0sT-Brutal: simplified to always use Winapi.Windows unit, removed dependencies,
...
const
  ...
  {$EXTERNALSYM SECBUFFER_APPLICATION_PROTOCOLS}
  SECBUFFER_SRTP_PROTECTION_PROFILES    = 19;
  {$EXTERNALSYM SECBUFFER_SRTP_PROTECTION_PROFILES}
  SECBUFFER_SRTP_MASTER_KEY_IDENTIFIER  = 20;
  {$EXTERNALSYM SECBUFFER_SRTP_MASTER_KEY_IDENTIFIER}
  SECBUFFER_TOKEN_BINDING               = 21;
  {$EXTERNALSYM SECBUFFER_TOKEN_BINDING}
  SECBUFFER_PRESHARED_KEY               = 22;
  {$EXTERNALSYM SECBUFFER_PRESHARED_KEY}
  SECBUFFER_PRESHARED_KEY_IDENTITY      = 23;
  {$EXTERNALSYM SECBUFFER_PRESHARED_KEY_IDENTITY}
  SECBUFFER_DTLS_MTU                    = 24;
  {$EXTERNALSYM SECBUFFER_DTLS_MTU}
